...
### Fixed
- Fix missing index warmer on replica shards in segment replication leading to cold start issues ([#20642](https://github.com/opensearch-project/OpenSearch/issues/20642))
