...
/**
 * Tests for {@link MinuteGcIndex}: builder, serialize/deserialize, and ShardRange merge.
 */
public class MinuteGcIndexTests extends OpenSearchTestCase {
    ...
    public void testDeserializeTruncatedBytesReturnsEmpty() {
        // Only 1 byte — not enough for even the 2-byte numIndices header
        MinuteGcIndex result = MinuteGcIndex.deserialize(new byte[] { 0x00 });
