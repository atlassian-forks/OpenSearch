...
/**
 * One shard's entry in the archive index: (shardId, primaryTerm, generation)
 * and byte ranges for the .tlog and .ckp entries within a TAR blob.
 * Plugin-internal — not part of the public API.
 */
final class ArchiveIndexEntry {
