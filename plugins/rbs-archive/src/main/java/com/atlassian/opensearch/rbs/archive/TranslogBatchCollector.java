 ...
 */
@ExperimentalApi
public final class TranslogBatchCollector extends AbstractLifecycleComponent implements LocalNodeClusterManagerListener {
     ...
     */
    public TranslogBatchCoordinator getCoordinator() {
        return coordinator;
    }
}
