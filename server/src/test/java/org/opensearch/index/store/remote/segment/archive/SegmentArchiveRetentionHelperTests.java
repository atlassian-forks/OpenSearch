...
public class SegmentArchiveRetentionHelperTests extends OpenSearchTestCase {
    ...
    public void testStaleArchiveIdentified() {
        Set<String> allBlobs = new HashSet<>(
            Arrays.asList(
                "segment_archive_1710000000000_abc123.zip",   // stale
                "segment_archive_1710000001000_def456.zip",   // active
        ...
        Set<String> activeUploaded = new HashSet<>(
            Arrays.asList(
                "segment_archive_1710000001000_def456.zip",   // referenced by metadata
                "_0.si__uuid1",
                "_0.cfs__uuid2"
            )
        );
        ...
        assertEquals("segment_archive_1710000000000_abc123.zip", stale.get(0));
    }
    ...
    public void testActiveArchivePreserved() {
        Set<String> allBlobs = new HashSet<>(Arrays.asList("segment_archive_1710000001000_def456.zip"));

        Set<String> activeUploaded = new HashSet<>(Arrays.asList("segment_archive_1710000001000_def456.zip"));
    ...
    public void testMixedArchivesOnlyStaleDeleted() {
        Set<String> allBlobs = new HashSet<>(
            Arrays.asList(
                "segment_archive_1710000000000_aaa.zip",   // stale
                "segment_archive_1710000001000_bbb.zip",   // active
                "segment_archive_1710000002000_ccc.zip",   // stale
                "segment_archive_1710000003000_ddd.zip",   // active
        ...
        Set<String> activeUploaded = new HashSet<>(
            Arrays.asList(
                "segment_archive_1710000001000_bbb.zip",
                "segment_archive_1710000003000_ddd.zip",
                "_0.si__uuid1",
                "_1.cfs__uuid2",
                "segments_1__uuid3"
            )
        ...
        assertTrue(stale.contains("segment_archive_1710000000000_aaa.zip"));
        assertTrue(stale.contains("segment_archive_1710000002000_ccc.zip"));
    ...
    public void testIsArchiveBlob() {
        assertTrue(SegmentArchiveRetentionHelper.isArchiveBlob("segment_archive_1710000000000_abc.zip"));
        assertTrue(SegmentArchiveRetentionHelper.isArchiveBlob("segment_archive_123.zip"));
    ...
    public void testExtractUploadedFilename() {
        ...
        assertEquals(
            "segment_archive_123_abc.zip",
            SegmentArchiveRetentionHelper.extractUploadedFilename("_0.si::segment_archive_123_abc.zip::12345::100::9")
        );
    ...
    public void testCollectActiveUploadedFilenames() {
        ...
        metadata1.put("_0.si", "_0.si::segment_archive_1000_aaa.zip::111::50::9");
        metadata1.put("_0.cfs", "_0.cfs::segment_archive_1000_aaa.zip::222::500::9");

        Map<String, String> metadata2 = new HashMap<>();
        metadata2.put("_0.si", "_0.si::segment_archive_2000_bbb.zip::333::50::9");
        ...
        assertTrue(active.contains("segment_archive_1000_aaa.zip"));
        assertTrue(active.contains("segment_archive_2000_bbb.zip"));
    ...
    public void testAllArchivesStaleWhenNoMetadataReferencesArchives() {
        Set<String> allBlobs = new HashSet<>(
            Arrays.asList("segment_archive_1000_aaa.zip", "segment_archive_2000_bbb.zip", "segment_archive_3000_ccc.zip")
        );
